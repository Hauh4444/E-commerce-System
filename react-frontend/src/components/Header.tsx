...
const Header = () => {
    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b-2 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/85">
            <nav className="flex h-[80px] items-center justify-between px-8" aria-label="Main navigation">
                ...
                <span className="max-w-[50%] flex grow">
                    <Input
                        id="search-query"
                        className="h-11 p-4 border-border rounded-full !text-base"
                        type="text"
                        placeholder="Search"
                        value={query}
